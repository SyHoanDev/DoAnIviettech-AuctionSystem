                    ...
                    <div class="span12">
                        ...
                        <div id="myCarousel-5" class="myCarousel carousel slide">
                            <div class="carousel-inner">
                                <div class="active item">
                                    <ul class="thumbnails">
                                        <c:forEach var="auctionRecently" items="${auctionList2}">
                                            <li class="span3">
                                                <div class="product-box">

                                                    <span class="sale_tag"></span>
                                                    <p><img src="/getImage/${auctionRecently.goods.imageList.get(0).url}" alt="" /></p>
                                                    ${auctionRecently.goods.goodName}</a><br/>
<%--                                                    <a href="${pageContext.request.contextPath}/productDetail/${auction.id}" class="bidMax">${auction.maxBid} VNĐ</a><br/>--%>
                                                        <span>Đấu giá sau </span>
                                                        <span id="h${auctionRecently.id}"> ${auctionRecently.nextHours}</span> :
                                                        <span id="m${auctionRecently.id}">${auctionRecently.nextMinutes}</span>
<%--                                                        --%>
                                                    </a>
                                                </div>
                                            </li>
