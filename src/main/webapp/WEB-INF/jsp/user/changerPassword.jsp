    ...
    <section class="main-content">
        <div class="row">
            ...
            <div class="span7" style="width: 100%">
                ...
                <p align="center" style="color:red;">${successMessage}</p>
                ...
                <form action="${pageContext.request.contextPath}/user/changePassword" method="post">
                    <fieldset>
                        <div style="margin-left: 480px" class="control-group">
                            ...
                            <div class="controls">
                                <input type="password" name="password" required placeholder="Mật khẩu có tối thiểu 8 ký tự"/>
                            </div>
                        </div>
                        <div style="margin-left: 480px" class="control-group">
                            <label class="control-label">Nhập mật khẩu mới</label>
                            <div class="controls">
                                <input type="password" name="newPass" required placeholder="Mật khẩu có tối thiểu 8 ký tự"/>
                            </div>
                        </div>
                        <div style="margin-left: 480px" class="control-group">
                            <label class="control-label">Nhập lại mật khẩu mới</label>
                            <div class="controls">
                                <input type="password" name="confirmPass" placeholder="Phải khớp với mật khẩu mới" required/>
                            </div>
                        </div>
