                            ...
                            <div class="calendar-heading">
                                ...
                                <div class="agile-tables">
                                    ...
                                    <div class="w3l-table-info">
                                        <form action="${pageContext.request.contextPath}/staff/viewAccount/search/1" method="post">
                                            <input type="text" name="search" required placeholder="Nhập Username">
                                            <input type="submit" value="Tìm kiếm">
                                            <a href="${pageContext.request.contextPath}/staff/viewAccount"><input type="button" value="Xem tất cả"></a>
                                        </form>
<%--                                        /////--%>
                                            ...
                                            <table id="table">
                                                ...
                                                <tbody>
                                                <c:forEach var="account" items="${accountLists.pageList}">
                                                    <tr class="info">
                                                        <td>${account.id}</td>
                                                        <td>${account.userName}</td>
                                                        <td><input type="password" value="${account.passWord}"></td>
                                                        <td>${account.enabled}</td>
                                                        <td style="text-align: center;">
							<span >
								<a class="agile-icon" href="${pageContext.request.contextPath}/staff/updateAccount/${account.id}"><i class="fa fa-pencil-square-o"></i></a>
							</span>
                                    ...
                                    <div id="page-pagination">
                                        <ul class="pagination">
                                            <li class="${currentIndex == 1}? 'page-item disabled' : 'page-item'">
                                                <a class="page-link" href="${pageContext.request.contextPath}/staff/viewAccount/page/1"><input type="button" value="First"></a>
                                            </li>
                                            <li class="${currentIndex == 1}? 'page-item disabled': 'page-item' ">
